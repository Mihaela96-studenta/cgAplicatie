...
<?php include ("./layout/meniu.html");?>
  <div class="container-md w-50 p-3">
    ...
    <form method="post" action="http://localhost/clonarecgAplicatie/crud/post_update.php?idutilizator=<?php echo $row['id']; ?>"  enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
      <div class="col-md-12">
