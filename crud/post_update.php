...
<?php
    if(isset($error) && $error===true){
        ...
        $sql = " UPDATE utilizatori SET prenume ='".$prenume."', nume='".$nume."',email='".$email."',datanastere='".$datanastere."',sex= '".$sex."', telefon= '".$telefon."',poza='".$poza."' WHERE id= $id";
        }else {
            $sql = " UPDATE utilizatori SET prenume ='".$prenume."', nume='".$nume."',email='".$email."',datanastere='".$datanastere."',sex= '".$sex."', telefon= '".$telefon."' WHERE id= $id";
        }
